...
class ModelRepository {
  ...
  final List<Map<String, String>> classObjects = [
    ...
    {"id": "vn26_02", "name": "Afzelia pachyloba"},
    ...
    {"id": "vn26_03", "name": "Autranella congolensis"},
    {"id": "vn26_04", "name": "Berlinia bracteosa"},
    ...
    {"id": "vn26_06", "name": "Cylicodiscus gabunensis"},
    {"id": "vn100", "name": "Dalbergia cochinchinensis"},
    {"id": "vn100", "name": "Dalbergia oliveri"},
    {"id": "vn26_09", "name": "Detarium macrocarpum"},
    ...
    {"id": "vn26_10", "name": "Distemonanthus benthamianus"},
    {"id": "vn100", "name": "Engelhardia chrysolepis"},
    {"id": "vn26_11", "name": "Entandrophragma cylindricum"},
    ...
    {"id": "vn26_13", "name": "Guarea cedrata"},
    {"id": "vn26_14", "name": "Guibourtia coleosperma"},
    ...
    {"id": "vn26_17", "name": "Milicia excelsa"},
    {"id": "vn100", "name": "Milicia regia"},
    {"id": "vn26_18", "name": "Millettia laurentii"},
    ...
    {"id": "vn26_20", "name": "Nauclea diderrichii"},
    {"id": "vn26_21", "name": "Pachyelasma tessmannii"},
    {"id": "vn100", "name": "Palaquium waburgianum"},
    {"id": "vn100", "name": "Pericopsis elata"},
    {"id": "vn100", "name": "Pinus sp."},
    {"id": "vn26_22", "name": "Piptadeniastrum africanum"},
    {"id": "vn100", "name": "Populus sp."},
    {"id": "vn100", "name": "Prunus serotina"},
    {"id": "vn100", "name": "Pterocarpus macrocarpus"},
    {"id": "vn26_25", "name": "Pterocarpus soyauxii"},
    {"id": "vn26_23", "name": "Pterocarpus sp."},
